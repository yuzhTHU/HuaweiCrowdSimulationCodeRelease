...
> This section demonstrates the actual performance of the RAPID framework when deployed in an online production environment, prepared as supplementary materials in response to reviewer KFSt's second concern during the KDD Rebuttal.
