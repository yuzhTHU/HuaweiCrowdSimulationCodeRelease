...
from ..data.data import Pedestrians
...
class NetEGNN_acce(nn.Module, Pedestrians):
    """
        use convegnn4
    """
...
class NetEGNN_acce2(nn.Module, Pedestrians):
    """
        use convegnn2
        remove encode v & a
    """
...
class NetEGNN_acce_hid(nn.Module, Pedestrians):
    """
        use convegnn2
        remove encode v & a
...
class NetEGNN_hid(nn.Module, Pedestrians):
    def __init__(self, in_dim=3+8+8, hid_dim=64, out_dim=1, n_layers=3, cuda=True):
        super().__init__()
        self.hid_dim=hid_dim
        self.k_dim = 3
...
class NetEGNN_hid_obs(nn.Module, Pedestrians):
    def __init__(self, in_dim=3+8+8, hid_dim=64, out_dim=1, n_layers=3, cuda=True):
        super().__init__()
        self.hid_dim=hid_dim
        self.k_dim = 3
...
class NetEGNN_hid2(nn.Module, Pedestrians):
    def __init__(self, in_dim=3+8+8, hid_dim=64, out_dim=1, n_layers=3, cuda=True):
        super().__init__()
        self.hid_dim=hid_dim
        self.k_dim = 3
...
class NetEGNN_hid_obs2(nn.Module, Pedestrians):
    def __init__(self, in_dim=3+8+8, hid_dim=64, out_dim=1, n_layers=3, cuda=True):
        super().__init__()
        self.hid_dim=hid_dim
        self.k_dim = 3
...
class NetEGNN_hid2_5_1_withfl(nn.Module, Pedestrians):
    def __init__(self, in_dim=3+8+8, hid_dim=64, out_dim=1, n_layers=3, cuda=True):
        super().__init__()
        self.hid_dim=hid_dim
        self.k_dim = 3
...
class NetEGNN_hid_ped_obs2(nn.Module, Pedestrians):
