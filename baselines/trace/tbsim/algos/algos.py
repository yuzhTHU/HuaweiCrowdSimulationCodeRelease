...
from ...tbsim.utils import tensor_utils as TensorUtils
from ...tbsim.utils import metrics as Metrics
...
class DiffuserTrafficModel(pl.LightningModule):
    ...
    def forward(self, obs_dict, num_samp=1, class_free_guide_w=0.0, guide_as_filter_only=False, guide_clean=False, return_diffusion=True):
